					...
					<ul class="clearfix">
						<li>
							<a href="/carrinho" rel="nofollow">
								Seu Carrinho(${carrinhoCompras.quantidade })</a>
						</li>
						<li>
		...
		<div class="clearfix container">
			<div id="collections-footer">
				...
				<ul class="footer-text-links">
					...
					<li><a href="/collections/livros-desenvolvimento-web">DesenvolvimentoWeb</a></li>
			...
			<div id="social-footer">
				...
				<ul class="footer-text-links">
					...
					<li><a href="/pages/sobre-a-casa-do-codigo">Sobre a Casado Código</a></li>
				...
				<ul>
					<li class="social-links"><a href="http://www.twitter.com/casadocodigo" target="_blank" id="twitter" rel="nofollow">Facebook</a> 
